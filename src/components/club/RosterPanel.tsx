...
export const RosterPanel: React.FC<RosterPanelProps> = ({
  ...
  function mapTournamentRosterPlayers(roster: TournamentRosterWithPlayers) {
    return roster.players.map((entry) => ({
      ...
      licenseVerified: entry.player.license_status === "valid",
      licenseStatus: entry.player.license_status,
      licenseVerifiedAt: entry.player.license_verified_at || undefined,
      licenseVerifiedBy: entry.player.license_verified_by || undefined,
